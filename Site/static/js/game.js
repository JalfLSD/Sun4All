...
function addSpot() {
    spots[spotCount] = "~spot:{" + selection.attrs.x + "," + selection.attrs.y + "," + selection.attrs.width + "," + selection.attrs.height + "}";
    spotCount++;
    $('#lblspotCount').text('Spots count: ' + spotCount);
    drawSelection("yellow");
    $('#pictureCanvas').show();
}

function addCluster() {
    clusters[clusterCount] = "~cluster:{" + selection.attrs.x + "," + selection.attrs.y + "," + selection.attrs.width + "," + selection.attrs.height + "}";
    clusterCount++;
